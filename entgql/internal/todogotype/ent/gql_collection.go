...
// CollectFields tells the query-builder to eagerly load connected nodes by resolver context.
func (pq *PetQuery) CollectFields(ctx context.Context, satisfies ...string) (*PetQuery, error) {
	fc := graphql.GetFieldContext(ctx)
	if fc == nil {
		return pq, nil
	}
...
func (pq *PetQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	var (
		unknownSeen    bool
